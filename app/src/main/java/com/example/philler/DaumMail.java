...
public class DaumMail extends AppCompatActivity implements View.OnClickListener{
    WebView daumView;
    EditText emailView;
    String str;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daum_mail);

        daumView = findViewById(R.id.daumView);
        emailView = findViewById(R.id.editText);
        startBtn = findViewById(R.id.button);
        startBtn.setOnClickListener(this);

        daumView.getSettings().setJavaScriptEnabled(true);
        daumView.getSettings().setBuiltInZoomControls(true);
        daumView.getSettings().setJavaScriptCanOpenWindowsAutomatically(true);
        daumView.getSettings().setLightTouchEnabled(true);
        daumView.getSettings().setSaveFormData(true);

        daumView.setWebViewClient(new MyWebViewClient());
        daumView.loadUrl("http://m.mail.daum.net");
    }
