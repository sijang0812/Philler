...
public class NaverMail extends AppCompatActivity implements View.OnClickListener{
    WebView naverView;
    EditText emailView;
    String str;
    Button startBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_naver_mail);
        ...
        naverView.getSettings().setBuiltInZoomControls(true);
        naverView.getSettings().setJavaScriptCanOpenWindowsAutomatically(true);
        naverView.getSettings().setLightTouchEnabled(true);
        naverView.getSettings().setSaveFormData(true);

        naverView.setWebViewClient(new MyWebViewClient());
        naverView.loadUrl("http://m.mail.naver.com");
    }
